...
lb3d_solute.set_liquid_thermal_diffusivity(0.001)
lb3d_solute.set_solid_thermal_diffusivity(0.005)
lb3d_solute.set_latent_heat(0.1)
lb3d_solute.set_ref_T(-5.0)
lb3d_solute.set_buoyancy_parameter(1.1)
